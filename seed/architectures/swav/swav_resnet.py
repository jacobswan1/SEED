...
__all__ = ['swav_resnet50', 'swav_resnet50w2', 'swav_resnet50w4', 'swav_resnet50w4', 'swav_resnet50w5']
...
def swav_resnet50(**kwargs):
    return ResNet(Bottleneck, [3, 4, 6, 3], **kwargs)


def swav_resnet50w2(**kwargs):
    return ResNet(Bottleneck, [3, 4, 6, 3], widen=2, **kwargs)


def swav_resnet50w4(**kwargs):
    return ResNet(Bottleneck, [3, 4, 6, 3], widen=4, **kwargs)


def swav_resnet50w5(**kwargs):
